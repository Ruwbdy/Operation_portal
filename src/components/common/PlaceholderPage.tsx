...
import { PanelLeftClose, PanelLeftOpen, Construction } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4 mb-1">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <div className="flex items-center space-x-2">
                  <span className="bg-gray-400 text-white text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-widest">
                    Coming Soon
                  </span>
                </div>
              </div>
